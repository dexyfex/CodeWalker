namespace CodeWalker.Project.Panels
{
    partial class EditYmapEntityPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            "32 - Static entity",
            "64 - Is Interior LOD",
            "128 - LOD Use Alt Fade",
            "256 - Unused",
            "512 - Does Not Touch Water",
            "1024 - Does Not Spawn Peds",
            "2048 - Cast Static Shadows",
            "4096 - Cast Dynamic Shadows",
            "8192 - Dont Render In Shadows",
            "16384 - Only Render In Shadows",
            "32768 - Dont Render Reflections",
            "65536 - Only Render Reflections",
            "131072 -  Dont Render Water Reflections",
            "262144 - Only Render Water Reflections",
            "524288 -  Dont Render Mirror Reflections",
            "1048576 - Only Render Mirror Reflections"});
